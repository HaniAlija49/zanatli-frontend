...
@Component({
  ...
  styles: [`
    ...
    .message-input-field ::ng-deep .mat-mdc-form-field {
      width: 100%;
    }
    ...
    .message-input-field ::ng-deep .mat-mdc-form-field-infix {
      padding: 0.5rem 0;
    }
...
export class ChatDialogComponent implements OnInit, AfterViewChecked {
  ...
  loadMessages() {
    this.messagesService.getMessages(this.data.jobId).subscribe({
      next: (messages) => {
  ...
  sendMessage() {
    ...
    // Send to server
    this.messagesService.sendMessage(this.data.jobId, { text: tempMessage.text }).subscribe({
      next: (message) => {
